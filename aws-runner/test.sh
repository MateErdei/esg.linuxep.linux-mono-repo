...
RESULT=0
EXCLUSIONS='-e MANUAL -e EXCLUDE_AWS -e CUSTOM_LOCATION -e TESTFAILURE -e FUZZ -e MCS_FUZZ
-e TAP_PARALLEL1 -e TAP_PARALLEL2 -e TAP_PARALLEL3 -e TAP_PARALLEL4 -e TAP_PARALLEL5 -e TAP_PARALLEL6'
