...
namespace Common
{
    namespace EventJournalWrapper
    {
        ...
        public:
            ...
            virtual std::vector<Entry> getEntries(std::vector<Subject> subjectFilter, uint64_t startTime, uint64_t endTime, uint32_t maxMemoryThreshold, bool& moreAvailable) = 0;
