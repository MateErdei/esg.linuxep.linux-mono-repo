...
namespace livequery{
    ...
    /**
     * Exception raised on the constructor of Response Data if the ColumnData and ColumnHeaders do not hold the validation.
     */
    ...
    public:
        /**
         * The empty case is to be explicit when constructing QueryResponse for error cases for which ColumnHeaders are not available
         * @return
         */
        static ResponseData emptyResponse();
        enum class AcceptedTypes{ BIGINT, STRING};
        ...
        enum class MarkDataExceeded{DataExceedLimit};
        /**
