...
BUILD_ARCH=${BUILD_ARCH:-linux_x64_rel}

SRC_DIR=/vagrant/esg.linuxep.linux-mono-repo/.output
BASE_DIR=$SRC_DIR/base
BASE_ZIP=$BASE_DIR/${BUILD_ARCH}/installer.zip
...
SDDS_BASE=/opt/test/inputs/base-sdds
unpack_zip_if_required "${BASE_ZIP}" "$SDDS_BASE"
...
EDR_ZIP=$SRC_DIR/edr/${BUILD_ARCH}/installer.zip
SDDS_COMPONENT=/opt/test/inputs/edr_sdds

unpack_zip_if_required $EDR_ZIP $SDDS_COMPONENT
