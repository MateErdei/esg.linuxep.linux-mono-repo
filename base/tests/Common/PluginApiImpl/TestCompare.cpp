...
::testing::AssertionResult TestCompare::dataMessageSimilar(
    const char* m_expr,
    const char* n_expr,
    ...
    const Common::PluginProtocol::DataMessage& resulted)
{
    ...
    {
        return ::testing::AssertionFailure()
               << s.str() << " Acknowledge differ: \n expected: " << ::testing::PrintToString(expected.m_acknowledge)
    ...
    {
        return ::testing::AssertionFailure()
               << s.str() << " Payload differ: \n expected: " << ::testing::PrintToString(expected.m_payload)
