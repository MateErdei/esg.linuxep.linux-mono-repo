...
AbstractFakeTimeUtils::AbstractFakeTimeUtils(std::chrono::milliseconds cacheTimeWindow,
...
std::time_t AbstractFakeTimeUtils::getCurrentTime()
{
    ...
    auto elapsed_time_since_last_change = std::chrono::duration_cast<std::chrono::milliseconds>(now - m_lastChangedTime);
...
SequenceOfFakeTime::SequenceOfFakeTime(std::vector<std::time_t> times_to_return,
...
AbstractFakeTimeUtils::NextTimeStruct SequenceOfFakeTime::getNextTime(std::chrono::milliseconds /*durationOfSimulation*/)
{
