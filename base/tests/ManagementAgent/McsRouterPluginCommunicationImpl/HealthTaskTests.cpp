...
TEST_F(HealthTaskTests, run_healthStatusMessageIsUpdatedWhenDifferentFromCachedValue) // NOLINT
{
    ...
    std::string expectedXml = "<?xml version=\"1.0\" encoding=\"utf-8\" ?><health version=\"3.0.0\" activeHeartbeat=\"false\" activeHeartbeatUtmId=\"\"><item name=\"health\" value=\"0\" /><item name=\"service\" value=\"0\" ><detail name=\"Sophos MCS Client\" value=\"0\" /></item><item name=\"threatService\" value=\"0\" ><detail name=\"Sophos MCS Client\" value=\"0\" /></item><item name=\"threat\" value=\"0\" /><item name=\"admin\" value=\"0\" /></health>";
...
TEST_F(HealthTaskTests, run_healthStatusMessageIsUpdatedWhenStatusFileFailsToWriteSuccessfully) // NOLINT
{
    ...
    std::string expectedXmlGood = "<?xml version=\"1.0\" encoding=\"utf-8\" ?><health version=\"3.0.0\" activeHeartbeat=\"false\" activeHeartbeatUtmId=\"\"><item name=\"health\" value=\"0\" /><item name=\"service\" value=\"0\" ><detail name=\"Sophos MCS Client\" value=\"0\" /><detail name=\"Plugin One\" value=\"0\" /></item><item name=\"threatService\" value=\"0\" ><detail name=\"Sophos MCS Client\" value=\"0\" /></item><item name=\"threat\" value=\"0\" /><item name=\"admin\" value=\"0\" /></health>";
    std::string expectedXmlBad = "<?xml version=\"1.0\" encoding=\"utf-8\" ?><health version=\"3.0.0\" activeHeartbeat=\"false\" activeHeartbeatUtmId=\"\"><item name=\"health\" value=\"1\" /><item name=\"service\" value=\"1\" ><detail name=\"Sophos MCS Client\" value=\"0\" /><detail name=\"Plugin One\" value=\"1\" /></item><item name=\"threatService\" value=\"0\" ><detail name=\"Sophos MCS Client\" value=\"0\" /></item><item name=\"threat\" value=\"0\" /><item name=\"admin\" value=\"0\" /></health>";
