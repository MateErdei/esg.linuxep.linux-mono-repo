...
class TestLiveQueryAdapter(unittest.TestCase):
    ...
    def test_live_query_adapter_process_command_xml_and_writes_file_to_temp_action_dir(self):
        ...
        mock_i.assert_called_once_with(f'./install/base/mcs/tmp/actions/{expected_date_string}_LiveQuery_correlation-id_request_{creation_time}_1591704123.json', 'wb', -1)
        handle = mock_i()
