...
# import mcsrouter.adapters.ConfigManager
...
class TestMCSAdapter(unittest.TestCase):
    ...
    def testApplyPolicy(self):
        ...
        adapter.processCommand(command)
        ...
        self.assertEqual(policy_config.getInt("COMMAND_CHECK_INTERVAL_MINIMUM",0),20)
        self.assertEqual(policy_config.getInt("COMMAND_CHECK_INTERVAL_MAXIMUM",0),20)
...
"""
        ...
        self.assertEqual(policy_config.getInt("COMMAND_CHECK_INTERVAL_MINIMUM",1337),1337)
        self.assertEqual(policy_config.getInt("COMMAND_CHECK_INTERVAL_MAXIMUM",1337),1337)
...
<configuration xmlns:auto-ns1="com.sophos\mansys\policy" xmlns="http://www.sophos.com/xml/msys/mcspolicy.xsd">
    ...
    <commandPollingDelay default="321"/>
        ...
        self.assertEqual(policy_config.getInt("COMMAND_CHECK_INTERVAL_MINIMUM",0),123)
        self.assertEqual(policy_config.getInt("COMMAND_CHECK_INTERVAL_MAXIMUM",0),123)
...
<configuration xmlns:auto-ns1="com.sophos\mansys\policy" xmlns="http://www.sophos.com/xml/msys/mcspolicy.xsd">
    <commandPollingDelay/>
        ...
        self.assertEqual(policy_config.getInt("COMMAND_CHECK_INTERVAL_MINIMUM",0),15)
        self.assertEqual(policy_config.getInt("COMMAND_CHECK_INTERVAL_MAXIMUM",0),15)
...
<configuration xmlns:auto-ns1="com.sophos\mansys\policy" xmlns="http://www.sophos.com/xml/msys/mcspolicy.xsd">
    <servers>
        ...
        self.assertEqual(policy_config.getDefault("MCSURL",None),"FOOBAR")
...
<configuration xmlns:auto-ns1="com.sophos\mansys\policy" xmlns="http://www.sophos.com/xml/msys/mcspolicy.xsd">
    <servers>
      ...
      <server>https://mcs2.sandbox.sophos/sophos/management/ep</server>
        ...
        self.assertEqual(policy_config.getDefault("mcs_policy_url1",None),"https://mcs1.sandbox.sophos/sophos/management/ep")
        self.assertEqual(policy_config.getDefault("mcs_policy_url2",None),"https://mcs2.sandbox.sophos/sophos/management/ep")
        self.assertEqual(policy_config.getDefault("MCSURL",None),"FOOBAR")
...
<configuration xmlns:auto-ns1="com.sophos\mansys\policy" xmlns="http://www.sophos.com/xml/msys/mcspolicy.xsd">
     <proxies>
        ...
        self.assertEqual(policy_config.getDefault("mcs_policy_proxy",None),None)
...
<configuration xmlns:auto-ns1="com.sophos\mansys\policy" xmlns="http://www.sophos.com/xml/msys/mcspolicy.xsd">
     <proxies>
      ...
      <proxy>http://2.proxy.sophos:8080</proxy>
        ...
        self.assertEqual(policy_config.getDefault("mcs_policy_proxy",None),"http://1.proxy.sophos:8080")
...
<configuration xmlns:auto-ns1="com.sophos\mansys\policy" xmlns="http://www.sophos.com/xml/msys/mcspolicy.xsd">
    ...
    <proxyCredentials>
        ...
        self.assertEqual(policy_config.getDefault("mcs_policy_proxy",None),"http://1.proxy.sophos:8080")
        self.assertEqual(policy_config.getDefault("mcs_policy_proxy_credentials",None),"FOOBAR")
...
<configuration xmlns:auto-ns1="com.sophos\mansys\policy" xmlns="http://www.sophos.com/xml/msys/mcspolicy.xsd">
    ...
    <proxyCredentials>
      ...
      <credentials>passwordAndUsername2</credentials>
        ...
        self.assertEqual(policy_config.getDefault("mcs_policy_proxy",None),"http://1.proxy.sophos:8080")
        self.assertEqual(policy_config.getDefault("mcs_policy_proxy_credentials",None),"passwordAndUsername1")
...
<configuration xmlns:auto-ns1="com.sophos\mansys\policy" xmlns="http://www.sophos.com/xml/msys/mcspolicy.xsd">
    <servers>
      <server>https://mcs2.sandbox.sophos/sophos/management/ep</server>
        ...
        adapter.processCommand(command)
        self.assertTrue(command.m_complete)
        self.assertEqual(policy_config.getDefault("mcs_policy_url1",None),"https://mcs2.sandbox.sophos/sophos/management/ep")
        self.assertEqual(policy_config.getDefault("mcs_policy_url2",None),None)
  ...
  <csc:Comp RevID="5" policyType="25"/>
    <messageRelays>
      <messageRelay priority="1" port="8190" address="WIN-QS4JOM4FNKK" id="e5fe429b-c478-42f1-aed4-6b891d21b5b8"/>
        ...
        self.assertEqual(policy_config.getDefault("message_relay_priority1",None),"1")
        self.assertEqual(policy_config.getDefault("message_relay_port1",None),"8190")
        self.assertEqual(policy_config.getDefault("message_relay_address1",None),"WIN-QS4JOM4FNKK")
        self.assertEqual(policy_config.getDefault("message_relay_id1",None),"e5fe429b-c478-42f1-aed4-6b891d21b5b8")
  ...
  <csc:Comp RevID="5" policyType="25"/>
    <messageRelays>
      ...
      <messageRelay priority="0" port="8190" address="LOSE-QS4JOM4FNKK" id="e5fethan-c478-42f1-alex-6b891d21b5b8"/>
        ...
        self.assertEqual(policy_config.getDefault("message_relay_priority2",None),"0")
        self.assertEqual(policy_config.getDefault("message_relay_port2",None),"8190")
        self.assertEqual(policy_config.getDefault("message_relay_address2",None),"LOSE-QS4JOM4FNKK")
        self.assertEqual(policy_config.getDefault("message_relay_id2",None),"e5fethan-c478-42f1-alex-6b891d21b5b8")
...
<configuration xmlns:auto-ns1="com.sophos\mansys\policy" xmlns="http://www.sophos.com/xml/msys/mcspolicy.xsd">
  ...
  <csc:Comp RevID="5" policyType="25"/>
    <messageRelays>
        ...
        self.assertEqual(policy_config.getDefault("message_relay_priority1",None),None)
        self.assertEqual(policy_config.getDefault("message_relay_port1",None),None)
        self.assertEqual(policy_config.getDefault("message_relay_address1",None),None)
        self.assertEqual(policy_config.getDefault("message_relay_id1",None),None)
  ...
  <csc:Comp RevID="5" policyType="25"/>
    <messageRelays>
      ...
      <messageRelay priority="0" port="8190" address="LOSE-QS4JOM4FNKK" id="e5fethan-c478-42f1-alex-6b891d21b5b8"/>
        ...
        self.assertEqual(policy_config.getDefault("message_relay_priority1",None),"0")
        self.assertEqual(policy_config.getDefault("message_relay_port1",None),"8190")
        self.assertEqual(policy_config.getDefault("message_relay_address1",None),"LOSE-QS4JOM4FNKK")
        self.assertEqual(policy_config.getDefault("message_relay_id1",None),"e5fethan-c478-42f1-alex-6b891d21b5b8")
  ...
  <csc:Comp RevID="5" policyType="25"/>
    <messageRelays>
      <messageRelay priority="0" port="1066" address="WIN-QS4JOM4FNKK" id="e5fe429b-c478-42f1-aed4-6b891d21b5b8"/>
        ...
        self.assertEqual(policy_config.getDefault("message_relay_priority1",None),"0")
        self.assertEqual(policy_config.getDefault("message_relay_port1",None),"1066")
        self.assertEqual(policy_config.getDefault("message_relay_address1",None),"WIN-QS4JOM4FNKK")
        self.assertEqual(policy_config.getDefault("message_relay_id1",None),"e5fe429b-c478-42f1-aed4-6b891d21b5b8")

        self.assertEqual(policy_config.getDefault("message_relay_priority2",None),None)
        self.assertEqual(policy_config.getDefault("message_relay_port2",None),None)
        self.assertEqual(policy_config.getDefault("message_relay_address2",None),None)
        self.assertEqual(policy_config.getDefault("message_relay_id2",None),None)
