...
python3  -m robot -x robot.xml --loglevel TRACE ${EXCLUSIONS} ${PLATFORM_EXCLUDE_TAG} "$@" -t "We Can Upgrade From Dogfood to VUT Without Unexpected Errors" tests || RESULT=$?
