...
cp -r output/SDDS-COMPONENT/* ../esg.linuxep.sspl-warehouse/redist/base/latest/x64
rm -rf ../esg.linuxep.sspl-warehouse/redist/responseactions/latest/x64/*
cp -r output/RA-SDDS3-PACKAGE/* ../esg.linuxep.sspl-warehouse/redist/responseactions/latest/x64
