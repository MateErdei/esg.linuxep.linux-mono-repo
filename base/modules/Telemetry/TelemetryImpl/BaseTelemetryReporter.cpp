...
namespace Telemetry
{
    ...
    std::optional<std::string> BaseTelemetryReporter::getVersion()
    {
        ...
        return Common::UtilityImpl::extractValueFromIniFile(versionIniFilepath, "PRODUCT_VERSION");
    }
    ...
    std::optional<std::string> BaseTelemetryReporter::getEndpointId()
    {
        ...
        return Common::UtilityImpl::extractValueFromIniFile(configFilePath, "MCSID");
    }
