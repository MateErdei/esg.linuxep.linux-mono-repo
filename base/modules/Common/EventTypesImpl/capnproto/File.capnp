...
struct FileEvent {
    enum EventType {
        ...
        modified             @3;
        hardLinkCreated      @4;
        timestampsModified   @5;
        permissionsModified  @6;
        ownershipModified    @7;
        accessed             @8;
        binaryFileMapped     @9;
    }
    ...
    fileSize                     @3 :Common.OptionalUInt64;
    pathname                     @4 :Common.Pathname;
    ...
    sha256                      @10 :Common.SHA256;
    pesha256                    @11 :Common.SHA256;
    dacl                        @12 :Common.DACL;
    owner                       @13 :Common.SID;
    newTimestamps               @14 :Common.FileTimestamps;
}
...
# fileId
#
# This is the file ID and volume GUID of the file.  This will only be set
# for local files on NTFS and ReFS file systems.
#
# timestamps
#
# These are the various file timestamps for the file before the event occurred.
#
# fileInfo
#
# This field contains the number of hardlinks to the file and the file attributes.
...
# sha256
#
# This is the SHA256 of the file
#
# pesha256
#
# This is the PESHA256 of the WinPE binary.  It should not be set for non-WinPE files.
#
# dacl
#
# This is the DACL set on the file in the permissions changed event.
#
# owner
#
# This is the SID set on the file for the owner changed event.
#
# newTimestamps
#
# These are the new timestamps set on the file for the timestamps changed event.  Description of
