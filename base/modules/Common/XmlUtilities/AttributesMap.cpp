...
namespace
{
    ...
    /** SimpleXmlParser **/
    SimpleXmlParser::SimpleXmlParser( size_t maxdepth)
            : m_stack(), m_attributesMap(), m_maxdepth(maxdepth)
    {

    }

    void SimpleXmlParser::onStartElement(const std::string &element, AttributePairCollection attributes, const std::string & id)
    {
