...
namespace Common::Policy
{
    ...
    {
    public:
        ProductSubscription(std::string rigidName, std::string baseVersion, std::string tag, std::string fixedVersion) :
        ...
        {
            return (
                (rigidName_ == rhs.rigidName_) && (baseVersion_ == rhs.baseVersion_) && (tag_ == rhs.tag_) &&
