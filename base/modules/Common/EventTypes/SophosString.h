...
namespace Common
{
    namespace EventTypes
    {
        ...
        public:
             ...
             * Otherwise (2), a null-terminated sequence is expected: the length of the sequence to match is determined
            ...
            /**
             * @brief Returns a newly constructed string object with its value initialized to a copy of a substring of
             * this object.
             ...
             * @param len, number of characters to include in the substring (if the string is shorter, as many
             * characters as possible are used). A value of string::npos indicates all characters until the end of the
             * string.
            ...
            /**
             * @brief Returns a pointer to an array that contains a null-terminated sequence of characters (i.e., a
             * C-string) representing the current value of the string object.
