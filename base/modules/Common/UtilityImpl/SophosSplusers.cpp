...
namespace sophos
{
    ...
    std::string SophosSplUsers::splNetworkUser() const
    {
        return sophos::networkUser();
    }

    std::string sophos::SophosSplUsers::splNetworkGroup() const
    {
        return sophos::networkGroup();
    }
