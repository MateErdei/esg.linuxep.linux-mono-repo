...
namespace Common::Telemetry
{
    ...
    public:
         ...
         * @param key
         * @param value
         * @throws std::logic_error if the value does not exist
         */
        ...
        /**
         * Append an empty object to an array, or if the array does not exist create it.
         * @param arrayKey
        ...
        /**
         * this is intended to be used in case the user wants to perform more complex operations than what this helper
         * ordinarily permits through set, append and increment. If object doesn't exist it is created.
         * @param keyPath
         * @returns TelemetryObject at the given key
         */
         ...
         * @param cookie unique string to link the callback function to the callee
         * @param function
         */
