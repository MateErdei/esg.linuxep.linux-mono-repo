...
namespace Common
{
    namespace Obfuscation
    {
        ...
        public:
            ...
            /**
             * Wrapper for openssl EVP_EncryptInit_ex
             * @param ctx
             * @param cipher
             * @param impl
             * @param key
             ...
             * @return
             */
            virtual int EVP_EncryptInit_ex(
                EVP_CIPHER_CTX* ctx,
                const EVP_CIPHER* cipher,
                ENGINE* impl,
                const unsigned char* key,
                const unsigned char* iv) const = 0;
            /**
             * Wrapper for openssl EVP_EncryptUpdate
             * @param ctx
             * @param out
             * @param outl
             * @param in
            ...
            virtual int EVP_EncryptUpdate(
                ...
                int inl) const = 0;
            /**
             * Wrapper for openssl EVP_EncryptFinal_ex
             * @param ctx
             * @param outm
             * @param outl
             * @return
             */
            virtual int EVP_EncryptFinal_ex(EVP_CIPHER_CTX* ctx, unsigned char* out, int* outl) const = 0;
        };
