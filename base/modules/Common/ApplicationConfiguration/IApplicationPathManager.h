...
namespace Common::ApplicationConfiguration
{
    ...
    public:
        ...
        virtual std::string getActualUserGroupIdConfigPath() const = 0;
        virtual std::string getRequestedUserGroupIdConfigPath() const = 0;
        ...
        virtual std::string getMcsCurrentProxyFileName() const = 0;
        ...
        virtual std::string getLocalSdds3Repository() const = 0;
        ...
        virtual std::string getCloudMetadataJsonPath() const = 0;

        virtual std::string getUpdateMarkerFile() const = 0;
        /**
