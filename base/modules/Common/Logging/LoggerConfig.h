...
namespace Common
{
    ...
    namespace Logging
    {
         ...
         *
         *   Note: if no VERBOSITY is found either in the logbase session or global session, than DEBUG will be set as default.
         *   The reason for this is that there is no reason why in production this value would not be set correctly. But if it was not,
         *   then it is more likely that the developer will need to know the reason, hence, having a DEBUG level may help.
         *
         ...
         *
         *   Note: special behaviour when the applyGeneralConfig is passed LOGFORTEST. In this case, it is not try to read settings file.
         */
        ...
        class LoggerSophosSettings
        {
             ...
             *
             * @param productName: the name of the main product or the plugin. Known names: sophos_managementagent, suldownloader, updatescheduler...
             */
        ...
        public:
            ...
            /** The reason to make the LoggerSophosSettings a singleton is to allow a read-once per life-time of the settings.
             *  Later, on the initialization of the loggers, they can use this settings to apply specific settings for
             *  different components inside a main product.
             *
             ...
             *  VERBOSITY=DEBUG
             *
             *  which would cause the reactor logger to be setup as DEBUG mode accross entries (even inside updatescheduler).
             *
             * @return
             */
             ...
             * If there is a specific specialization for the product it returns the <productName>.VERBOSITY equivalent value.
             * If the product is empty, it will return the VERBOSITY associated with global or no association.
             * If no specific specialization for the product is found, it will not change logLevelOut and return false
             * @param productName
