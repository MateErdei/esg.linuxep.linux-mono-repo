...
{
public:
    SEUInstallError(const std::string& product, const std::string& installResult = "") :
        SEUError(ExitCode_InstallFailure, IDS_RMS_INST_ERROR, "Install.Failure")
    {
...
{
public:
    SEUUninstallError(const std::string& product, const std::string& uninstallResult = "") :
        SEUError(ExitCode_UninstallFailure, IDS_RMS_UNINST_ERROR, "Uninstall.Failure")
    {
...
{
public:
    SEUSyncError(const std::string& product, const std::string& url) :
        SEUError(ExitCode_SyncFailure, IDS_RMS_DWNLD_ERROR, "SDDSDownloadFailed")
    {
...
{
public:
    SEUMissingProductError(const std::string& rigidName) :
        SEUError(ExitCode_MissingProduct, IDS_RMS_MISSING_PRODUCT, "ProductMissing")
    {
