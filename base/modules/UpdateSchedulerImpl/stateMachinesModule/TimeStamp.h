...
namespace stateMachinesModule
{
    ...
    std::string MessageTimeStamp(const std::chrono::system_clock::time_point& time_point, stateMachinesModule::Granularity granularity = Granularity::milliseconds) noexcept;
