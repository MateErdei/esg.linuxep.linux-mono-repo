...
PYTHONPATH=${SYSTEMPRODUCTTESTSPATH}/libs/:$PYTHONPATH  FAKEWAREHOUSE="$PathOfWarehouseDirectory" python -c '
import UpdateServer
...
warehouseGenerator.generate_warehouse(fakeWarehouse, fakeserverpath, "ServerProtectionLinux-Base")
