...
def main():
    tags = {'include': ['COMMS'], 'exclude': ["OSTIA", "CENTRAL", "AMAZON_LINUX", "AUDIT_PLUGIN", "EVENT_PLUGIN", "EXAMPLE_PLUGIN", "MANUAL", "MESSAGE_RELAY", "PUB_SUB", "SAV", "SLOW", "TESTFAILURE", "UPDATE_CACHE", "FUZZ", "MDR_REGRESSION_TESTS", "FAULTINJECTION"]}
