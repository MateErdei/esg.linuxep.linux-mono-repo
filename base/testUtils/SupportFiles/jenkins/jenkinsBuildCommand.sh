...
platform_exclude_tag
# FIXME: LINUXDAR-2120 restore - remove comms exclusion
EXCLUDED_BY_DEFAULT_TAGS="COMMS MANUAL PUB_SUB FUZZ AUDIT_PLUGIN EVENT_PLUGIN TESTFAILURE MCS_FUZZ CUSTOM_LOCATION AMAZON_LINUX EXAMPLE_PLUGIN "$PLATFORM_EXCLUDE_TAG
