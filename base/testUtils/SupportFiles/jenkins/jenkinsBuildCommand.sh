...
export LIVERESPONSE_PLUGIN_SDDS="/tmp/liveresponse-plugin-SDDS-COMPONENT"
...
sudo rm -rf ${LIVERESPONSE_PLUGIN_SDDS}
...
sudo cp -r ${LIVERESPONSE_PLUGIN_SOURCE} ${LIVERESPONSE_PLUGIN_SDDS}
