...
export SSPL_MDR_PLUGIN_SDDS_060="$SYSTEMPRODUCT_TEST_INPUT/sspl-mdr-control-plugin-060"
...
export SDDS2_THININSTALLER="$SYSTEMPRODUCT_TEST_INPUT/sspl-legacy-thininstaller"
