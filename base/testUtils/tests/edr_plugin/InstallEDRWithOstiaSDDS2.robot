...
*** Test Cases ***
Install all plugins 999 then downgrade to all plugins develop using SDDS2
    [Tags]  BASE_DOWNGRADE  OSTIA  THIN_INSTALLER  INSTALLER  UNINSTALLER
    Install EDR SDDS2  ${BaseAndMTREdr999Policy}
...
Install edr 999 and downgrade to current edr using SDDS2
    [Tags]  PLUGIN_DOWNGRADE  OSTIA  THIN_INSTALLER  INSTALLER  UNINSTALLER
    Install EDR SDDS2  ${BaseMtrAndEdr999Policy}
...
Install master of base and edr and mtr and upgrade to edr 999 using SDDS2
    [Timeout]  10 minutes
    Install EDR SDDS2  ${BaseAndEdrAndMtrVUTPolicy}
...
Install master of base and edr and mtr and upgrade to new query pack using SDDS2
    Install EDR SDDS2  ${BaseAndEdrAndMtrVUTPolicy}
...
Install master of base and edr and mtr and av and upgrade to edr 999 and mtr 999 and av 999 using SDDS2
    [Timeout]  10 minutes
    Install EDR SDDS2  ${BaseEdrAndMtrAndAVVUTPolicy}
...
Install master of base and edr and mtr and upgrade to base 999 using SDDS2
    Install EDR SDDS2  ${BaseAndEdrAndMtrVUTPolicy}
