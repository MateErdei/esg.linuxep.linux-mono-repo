...
Telemetry Executable Generates Update Scheduler Telemetry With Fixed Version And Tag In Policy
    ...
    ${telemetryFileContents} =  Get File    ${TELEMETRY_OUTPUT_JSON}
    Log File   ${TELEMETRY_OUTPUT_JSON}
    Check Update Scheduler Telemetry Json Is Correct  ${telemetryFileContents}   0  mtr_fixed_version=1.0.2  base_fixed_version=2022.1.0.40  mtr_tag=BETA  sddsid=NotAUserName  install_state=0  download_state=0
