...
class TelemetryUtils:
    ...
    def check_watchdog_telemetry_is_correct(self, actual_dict, expected_dict):
        ...
        if actual_product_disk_usage and type(actual_product_disk_usage) is not int:
            raise AssertionError(f"Watchdog telemetry doesn't contain a valid product disk usage field: {actual_product_disk_usage}")

        assert actual_dict == expected_dict, f"actual watchdog telemetry: \n\t{actual_dict}\n did not match expected: \n\t{expected_dict}"
