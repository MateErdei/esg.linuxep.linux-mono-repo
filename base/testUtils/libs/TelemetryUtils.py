...
class TelemetryUtils:
    ...
    def generate_edr_telemetry_dict(self, num_osquery_restarts, num_database_purges, num_osquery_restarts_cpu,
                                    ...
                                    num_sophos_extension_restarts,
                                    num_logger_extension_restarts,
        ...
        telemetry = {
            ...
            "sophos-extension-restarts": int(num_sophos_extension_restarts),
            "logger-extension-restarts": int(num_logger_extension_restarts),
    ...
    def check_edr_telemetry_json_is_correct(self, json_string,
                                            ...
                                            num_sophos_extension_restarts=0,
                                            num_logger_extension_restarts=0,
