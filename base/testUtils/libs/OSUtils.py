...
def get_dictionary_of_expected_sockets_and_permissions():
    return {
        ...
        "/opt/sophos-spl/var/ipc/plugins/sdu.ipc":              ["sophos-spl-sdu", "sophos-spl-group", "srw-rw----"],
...
def get_dictionary_of_expected_base_logs_and_permissions():
    return {
        ...
        "/opt/sophos-spl/logs/base/sophosspl/remote_diagnose.log":             ["sophos-spl-sdu", "sophos-spl-group", "-rw-------"]
    }
