...
namespace Plugin
{
    ...
    public:
        ...
        bool isThreatInDatabaseWithinTime(const std::string& threatId, const std::chrono::seconds& duplicateTimeout)
            const;
        [[nodiscard]] std::optional<std::string> hasThreat(const std::string& threatId) const;
