...
public:
     ...
     */
    static bool isFloppy(const std::string& devicePath, const std::string& mountPoint = "", const std::string& filesystemType = "");
    /**
     ...
     * @param filesystemType    Optional type of device's filesystem.
     */
    static bool isLocalFixed(const std::string& devicePath, const std::string& mountPoint = "", const std::string& filesystemType = "");
    /**
     ...
     * @param filesystemType    Optional type of device's filesystem.
     */
    static bool isNetwork(const std::string& devicePath, const std::string& mountPoint = "", const std::string& filesystemType = "");
    /**
     ...
     * @param filesystemType    Optional type of device's filesystem.
     */
    static bool isOptical(const std::string& devicePath, const std::string& mountPoint = "", const std::string& filesystemType = "");
    /**
     ...
     * @param filesystemType    Optional type of device's filesystem.
     */
    static bool isSystem(const std::string& devicePath, const std::string& mountPoint = "", const std::string& filesystemType = "");
