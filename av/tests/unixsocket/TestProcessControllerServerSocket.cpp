...
TEST_F(TestProcessControllerServerSocket, test_construction) //NOLINT
{
...
TEST_F(TestProcessControllerServerSocket, test_running) // NOLINT
{
...
TEST_F(TestProcessControllerServerSocket, test_scan_threat) // NOLINT
{
...
TEST_F(TestProcessControllerServerSocket, test_scan_clean) // NOLINT
{
    static const std::string THREAT_PATH = "/dev/null";
    std::string socketPath = "scanning_socket";
    auto scannerFactory = std::make_shared<StrictMock<MockScannerFactory>>();
...
TEST_F(TestProcessControllerServerSocket, test_scan_twice) // NOLINT
{
    static const std::string THREAT_PATH = "/dev/null";
    std::string socketPath = "scanning_socket";
    auto scannerFactory = std::make_shared<StrictMock<MockScannerFactory>>();
...
TEST_F(TestProcessControllerServerSocket, test_scan_throws) // NOLINT
{
    static const std::string THREAT_PATH = "/dev/null";
    std::string socketPath = "scanning_socket";
    auto scannerFactory = std::make_shared<StrictMock<MockScannerFactory>>();
...
TEST_F(TestProcessControllerServerSocket, test_too_many_connections_are_refused) // NOLINT
{
    UsingMemoryAppender memoryAppenderHolder(*this);
