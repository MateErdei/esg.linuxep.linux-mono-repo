...
{
    const std::string settingsJson = R"sophos({"enableSxlLookup":true,"machineLearning":true,"oaPuaDetection":true,"odPuaDetection":true,"shaAllowList":["a651a4b1cda12a3bccde8e5c8fb83b3cff1f40977dfe562883808000ffe3f798","42268ef08462e645678ce738bd26518bc170a0404a186062e8b1bec2dc578673"]})sophos";
...
TEST_F(TestPolicyProcessor_CORC_policy, processCorcPolicyWithEmptyAllowList)
{
    ...
    std::string settingsJson = R"sophos({"enableSxlLookup":true,"machineLearning":true,"oaPuaDetection":true,"odPuaDetection":true,"shaAllowList":[]})sophos";
    expectConstructorCalls();
    expectWriteSusiConfigFromString(settingsJson);
...
TEST_F(TestPolicyProcessor_CORC_policy, processCorcPolicyWithOneEmptyShaTypeAllowListItem)
{
    ...
    std::string settingsJson = R"sophos({"enableSxlLookup":true,"machineLearning":true,"oaPuaDetection":true,"odPuaDetection":true,"shaAllowList":["42268ef08462e645678ce738bd26518bc170a0404a186062e8b1bec2dc578673"]})sophos";
    expectConstructorCalls();
    expectWriteSusiConfigFromString(settingsJson);
