...
EXIT_FAILURE=1
EXIT_WARNING=2
EXITCODE_INVALID_ARG=3
EXITCODE_BAD_INSTALL_PATH=4
EXITCODE_NOT_LINUX=5
EXITCODE_NOT_64_BIT=6
EXITCODE_NO_SYSTEMD=7
EXIT_FAIL_COULD_NOT_FIND_LIBC_VERSION=8
EXIT_FAIL_WRONG_LIBC_VERSION=9
EXITCODE_NOEXEC_TMP=10
EXITCODE_MISSING_PACKAGE=11
EXITCODE_NOT_ENOUGH_SPACE=12
EXITCODE_NOT_ENOUGH_MEM=13
EXITCODE_INVALID_CA_PATHS=14
...
function print_help_text() {
    ...
    echo -e "\nExit codes:"
    echo -e "\t- EXIT_SUCCESS=0"
    echo -e "\t- EXIT_FAILURE=1"
    echo -e "\t- EXIT_WARNING=2"
    echo -e "\t- EXITCODE_INVALID_ARG=3"
    echo -e "\t- EXITCODE_BAD_INSTALL_PATH=4"
    echo -e "\t- EXITCODE_NOT_LINUX=5"
    echo -e "\t- EXITCODE_NOT_64_BIT=6"
    echo -e "\t- EXITCODE_NO_SYSTEMD=7"
    echo -e "\t- EXIT_FAIL_COULD_NOT_FIND_LIBC_VERSION=8"
    echo -e "\t- EXIT_FAIL_WRONG_LIBC_VERSION=9"
    echo -e "\t- EXITCODE_NOEXEC_TMP=10"
    echo -e "\t- EXITCODE_MISSING_PACKAGE=11"
    echo -e "\t- EXITCODE_NOT_ENOUGH_SPACE=12"
    echo -e "\t- EXITCODE_NOT_ENOUGH_MEM=13"
    echo -e "\t- EXITCODE_INVALID_CA_PATHS=14"
}
...
if [[ -z "${CENTRAL_URL}" ]]; then
    ...
    echo "WARN: This Central URL may be incorrect depending on the region of the server"
fi
