...
EXIT_SUCCESS=0
EXITCODE_INVALID_ARG=1
EXITCODE_BAD_INSTALL_PATH=2
EXITCODE_NOT_LINUX=3
EXITCODE_NOT_64_BIT=4
EXITCODE_NO_SYSTEMD=5
EXIT_FAIL_COULD_NOT_FIND_LIBC_VERSION=6
EXIT_FAIL_WRONG_LIBC_VERSION=7
EXITCODE_NOEXEC_TMP=8
EXITCODE_MISSING_PACKAGE=9
EXITCODE_NOT_ENOUGH_SPACE=10
EXITCODE_NOT_ENOUGH_MEM=11
EXITCODE_INVALID_CA_PATHS=12
...
function print_help_text() {
  ...
  echo -e "\nExit codes:"
  echo -e "\t- SUCCESS=0"
  echo -e "\t- INVALID_ARG=1"
  echo -e "\t- BAD_INSTALL_PATH=2"
  echo -e "\t- NOT_LINUX=3"
  echo -e "\t- NOT_64_BIT=4"
  echo -e "\t- NO_SYSTEMD=5"
  echo -e "\t- COULD_NOT_FIND_LIBC_VERSION=6"
  echo -e "\t- WRONG_LIBC_VERSION=7"
  echo -e "\t- NOEXEC_TMP=8"
  echo -e "\t- MISSING_PACKAGE=9"
  echo -e "\t- NOT_ENOUGH_SPACE=10"
  echo -e "\t- NOT_ENOUGH_MEM=11"
  echo -e "\t- INVALID_CA_PATHS=12"
}
