...
Verify That There Are No Existing Configs to Openssl
    ...
    ${result} =    Run Process    sed    -i    s@\"/opt/sophos-spl/base/bin/sophos_watchdog\"@/bin/strace -o /tmp/strace.log -e trace\=open,openat -t -f ${SOPHOS_INSTALL}/base/bin/sophos_watchdog@g    ${serviceDir}/sophos-spl.service
