...
then
  ...
  cp /mnt/filer6/linux/SSPL/tools/gcc-gcc-6_4_0-release.tar.gz /root/gcc-build-test/ || failure "Could not copy gcc source tar"
...
echo "*/30 08-15  * * *  python3 /root/performance/RunEDRPerfTests.py -s central-livequery -r p -i <CENTRAL_ACCOUNT_ID> -p <CENTRAL_ACCOUNT_SECRET>"
echo "*/30 08-15  * * *  python3 /root/performance/RunEDRPerfTests.py -s central-livequery -r p -e LicenceDarwin+2@gmail.com -p <CENTRAL_ACCOUNT_PASSWORD>"
...
echo "*/30 16-21  * * *  python3 /root/performance/RunEDRPerfTests.py -s central-livequery -r p -i <CENTRAL_ACCOUNT_ID> -p <CENTRAL_ACCOUNT_SECRET>"
echo "*/30 16-21  * * *  python3 /root/performance/RunEDRPerfTests.py -s central-livequery -r p -e LicenceDarwin@gmail.com -p <CENTRAL_ACCOUNT_PASSWORD>"
echo "0 0 * * * /root/ssplDogfoodFeedback.sh && /opt/sophos-spl/bin/uninstall.sh --force"
echo ""
echo "# Run local live queries at 10am"
echo "0 10 * * *  python3 /root/performance/RunEDRPerfTests.py -s local-livequery"
echo ""
