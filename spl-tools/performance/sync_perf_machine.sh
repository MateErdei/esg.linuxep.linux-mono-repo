...
echo "*/30 08-15  * * *  python3 /root/performance/RunEDRPerfTests.py -s central-livequery -e testEUCentral-perf@savlinux.xmas.testqa.com -p <PASSWORD>"
...
echo "*/30 16-21  * * *  python3 /root/performance/RunEDRPerfTests.py -s central-livequery -e testEUCentral-Perf-MTR@savlinux.xmas.testqa.com -p <PASSWORD>"
